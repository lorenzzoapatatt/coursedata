...
`;var z,Ee=class extends d.HTMLElement{constructor(){var n;super();c(this,z);this.attachShadow({mode:"open"}).appendChild(It.content.cloneNode(!0)),this.srOnlyText=(n=this.shadowRoot)==null?void 0:n.getElementById("sr-only")}connectedCallback(){f(this,z,A(this)),i(this,z)&&(i(this,z).addEventListener("success",this.updateText.bind(this)),i(this,z).addEventListener("localechange",()=>{var r;(r=this.srOnlyText)!=null&&r.textContent&&this.updateText()}))}disconnectedCallback(){i(this,z)&&i(this,z).removeEventListener("success",this.updateText.bind(this))}updateText(){var r;if(this.srOnlyText){let n=(r=i(this,z))==null?void 0:r.locale;this.srOnlyText.textContent=v("Upload complete!",n)}}};z=new WeakMap;d.customElements.get("mux-uploader-sr-text")||d.customElements.define("mux-uploader-sr-text",Ee);var Hr=Ee;var ks=Bt;export{Pr as MuxUploaderDropElement,Ir as MuxUploaderFileSelectElement,Br as MuxUploaderPauseElement,Ur as MuxUploaderProgressElement,Or as MuxUploaderRetryElement,Hr as MuxUploaderSrTextElement,Dr as MuxUploaderStatusElement,we as constants,ks as default,v as t};
//# sourceMappingURL=mux-uploader.mjs.map
