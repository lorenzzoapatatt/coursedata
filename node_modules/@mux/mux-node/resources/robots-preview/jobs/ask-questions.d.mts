 ...
 */
export declare class AskQuestions extends APIResource {
    /**
...
export declare namespace AskQuestionsJob {
    /**
     * Related Mux resources linked to this job.
     */
    interface Resources {
...
export declare namespace AskQuestionsJobOutputs {
    interface Answer {
        /**
...
export declare namespace AskQuestionsJobParameters {
    interface Question {
        /**
...
export declare namespace AskQuestions {
    export { type AskQuestionsJob as AskQuestionsJob, type AskQuestionsJobOutputs as AskQuestionsJobOutputs, type AskQuestionsJobParameters as AskQuestionsJobParameters, type AskQuestionCreateParams as AskQuestionCreateParams, };
}
//# sourceMappingURL=ask-questions.d.mts.map