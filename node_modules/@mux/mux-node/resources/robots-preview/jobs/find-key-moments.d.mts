 ...
 */
export declare class FindKeyMoments extends APIResource {
    /**
...
export declare namespace FindKeyMomentsJob {
    /**
     * Related Mux resources linked to this job.
     */
    interface Resources {
...
export declare namespace FindKeyMomentsJobOutputs {
    interface Moment {
        /**
    ...
    namespace Moment {
        ...
        interface NotableVisualConcept {
            /**
...
export declare namespace FindKeyMomentsJobParameters {
    /**
     * Preferred highlight duration range in milliseconds. When provided, the model
     * will aim to select moments within this range.
     */
    interface TargetDurationMs {
        /**
...
export declare namespace FindKeyMoments {
    export { type FindKeyMomentsJob as FindKeyMomentsJob, type FindKeyMomentsJobOutputs as FindKeyMomentsJobOutputs, type FindKeyMomentsJobParameters as FindKeyMomentsJobParameters, type FindKeyMomentCreateParams as FindKeyMomentCreateParams, };
}
//# sourceMappingURL=find-key-moments.d.mts.map