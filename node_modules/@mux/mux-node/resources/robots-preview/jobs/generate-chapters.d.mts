 ...
 */
export declare class GenerateChapters extends APIResource {
    /**
...
export declare namespace GenerateChaptersJob {
    /**
     * Related Mux resources linked to this job.
     */
    interface Resources {
...
export declare namespace GenerateChaptersJobOutputs {
    interface Chapter {
        /**
...
export declare namespace GenerateChaptersJobParameters {
    /**
     * Override specific sections of the chapter generation prompt.
     */
...
export declare namespace GenerateChapters {
    export { type GenerateChaptersJob as GenerateChaptersJob, type GenerateChaptersJobOutputs as GenerateChaptersJobOutputs, type GenerateChaptersJobParameters as GenerateChaptersJobParameters, type GenerateChapterCreateParams as GenerateChapterCreateParams, };
}
//# sourceMappingURL=generate-chapters.d.mts.map