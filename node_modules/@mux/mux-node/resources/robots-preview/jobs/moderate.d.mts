 ...
 */
export declare class Moderate extends APIResource {
    /**
...
export declare namespace ModerateJob {
    /**
     * Related Mux resources linked to this job.
     */
    interface Resources {
...
export declare namespace ModerateJobOutputs {
    /**
     * Highest scores across all thumbnails for each category.
     */
    interface MaxScores {
...
export declare namespace ModerateJobParameters {
    /**
     * Score thresholds that determine whether content is flagged. When combined with
     * sampling_interval or max_samples, the exceeds_threshold flag reflects whether
     * any category's highest observed score exceeds its configured threshold. Defaults
...
export declare namespace Moderate {
    export { type ModerateJob as ModerateJob, type ModerateJobOutputs as ModerateJobOutputs, type ModerateJobParameters as ModerateJobParameters, type ModerateCreateParams as ModerateCreateParams, };
}
//# sourceMappingURL=moderate.d.mts.map