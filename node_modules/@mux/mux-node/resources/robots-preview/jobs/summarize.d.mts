 ...
 */
export declare class Summarize extends APIResource {
    /**
     ...
     * ```ts
     * const summarizeJob =
     *   await client.robotsPreview.jobs.summarize.create({
     *     parameters: {
...
export declare namespace SummarizeJob {
    /**
     * Related Mux resources linked to this job.
     */
    interface Resources {
...
export declare namespace SummarizeJobParameters {
    /**
     * Override specific sections of the summarization prompt.
     */
...
export declare namespace Summarize {
    export { type SummarizeJob as SummarizeJob, type SummarizeJobOutputs as SummarizeJobOutputs, type SummarizeJobParameters as SummarizeJobParameters, type SummarizeCreateParams as SummarizeCreateParams, };
}
//# sourceMappingURL=summarize.d.mts.map