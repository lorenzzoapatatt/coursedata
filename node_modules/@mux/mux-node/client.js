...
var _Mux_instances, _a, _Mux_encoder, _Mux_baseURLOverridden;
...
const data_1 = require("./resources/data/data.js");
const robots_preview_1 = require("./resources/robots-preview/robots-preview.js");
const system_1 = require("./resources/system/system.js");
const video_1 = require("./resources/video/video.js");
...
class Mux {
     ...
     */
    constructor({ baseURL = (0, env_1.readEnv)('MUX_BASE_URL'), tokenId = (0, env_1.readEnv)('MUX_TOKEN_ID') ?? null, tokenSecret = (0, env_1.readEnv)('MUX_TOKEN_SECRET') ?? null, webhookSecret = (0, env_1.readEnv)('MUX_WEBHOOK_SECRET') ?? null, jwtSigningKey = (0, env_1.readEnv)('MUX_SIGNING_KEY') ?? null, jwtPrivateKey = (0, env_1.readEnv)('MUX_PRIVATE_KEY') ?? null, authorizationToken = (0, env_1.readEnv)('MUX_AUTHORIZATION_TOKEN') ?? null, ...opts } = {}) {
        _Mux_instances.add(this);
        _Mux_encoder.set(this, void 0);
        this.video = new API.Video(this);
        this.robotsPreview = new API.RobotsPreview(this);
        ...
        this.logLevel =
            (0, log_1.parseLogLevel)(options.logLevel, 'ClientOptions.logLevel', this) ??
                (0, log_1.parseLogLevel)((0, env_1.readEnv)('MUX_LOG'), "process.env['MUX_LOG']", this) ??
                defaultLogLevel;
        this.fetchOptions = options.fetchOptions;
        this.maxRetries = options.maxRetries ?? 2;
        this.fetch = options.fetch ?? Shims.getDefaultFetch();
        tslib_1.__classPrivateFieldSet(this, _Mux_encoder, Opts.FallbackEncoder, "f");
        const customHeadersEnv = (0, env_1.readEnv)('MUX_CUSTOM_HEADERS');
        if (customHeadersEnv) {
            const parsed = {};
    ...
    validateHeaders({ values, nulls }) {
        ...
        throw new Error('Could not resolve authentication method. Expected either tokenId, tokenSecret or authorizationToken to be set. Or for one of the "Authorization" or "Authorization" headers to be explicitly omitted');
    }
    async authHeaders(opts) {
        return (0, headers_1.buildHeaders)([await this.accessTokenAuth(opts), await this.authorizationTokenAuth(opts)]);
    }
    async accessTokenAuth(opts) {
        if (!this.tokenId) {
            return undefined;
        }
        if (!this.tokenSecret) {
    ...
    async authorizationTokenAuth(opts) {
        if (this.authorizationToken == null) {
            return undefined;
        }
        return (0, headers_1.buildHeaders)([{ Authorization: `Bearer ${this.authorizationToken}` }]);
    }
    ...
    buildURL(path, query, defaultBaseURL) {
        const baseURL = (!tslib_1.__classPrivateFieldGet(this, _Mux_instances, "m", _Mux_baseURLOverridden).call(this) && defaultBaseURL) || this.baseURL;
    ...
    buildBody({ options: { body, headers: rawHeaders } }) {
        ...
        ArrayBuffer.isView(body) ||
            ...
            return tslib_1.__classPrivateFieldGet(this, _Mux_encoder, "f").call(this, { body, headers });
        }
    }
}
exports.Mux = Mux;
_a = Mux, _Mux_encoder = new WeakMap(), _Mux_instances = new WeakSet(), _Mux_baseURLOverridden = function _Mux_baseURLOverridden() {
...
Mux.Video = video_1.Video;
Mux.RobotsPreview = robots_preview_1.RobotsPreview;
Mux.Data = data_1.Data;
Mux.System = system_1.System;
Mux.Webhooks = webhooks_1.Webhooks;
